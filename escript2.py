#ESTA FUNCION LA DOCUMENTO CON FORMATO Google Docstrings
"""Este script esta hecho para testear formateos de documentacion con Google Docstrings como base de formato..
